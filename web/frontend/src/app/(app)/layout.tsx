      ...
      <aside className="w-64 bg-white border-r border-slate-100 flex flex-col fixed h-full z-40 shadow-card">
          ...
          {navItems.map(({ href, icon: Icon, label }) => {
            ...
            return (
              ...
              >
                ...
                <Icon className={`w-4 h-4 shrink-0 ${active ? "text-primary-700" : ""}`} />
                {label}
              </Link>
            );
          })}
        ...
        <div className="px-3 py-4 border-t border-slate-100 space-y-0.5">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-600 hover:text-red-600 hover:bg-red-50 transition-all duration-150 cursor-pointer"
          >

...
const features = [
  {
    ...
    title: "Tổng hợp từ 4 cổng việc làm",
    desc: "VietnamWorks, TopCV, ITviec, CareerViet — tìm một lần, thấy tất cả.",
    color: "bg-blue-50 text-primary-700",
  },
  {
    icon: <Sparkles className="w-5 h-5" />,
    title: "AI đánh giá độ phù hợp",
    desc: "Gemini AI chấm điểm và giải thích chi tiết tại sao bạn phù hợp với vị trí đó.",
    color: "bg-amber-50 text-accent-700",
  },
  {
    icon: <FileText className="w-5 h-5" />,
    title: "CV builder thông minh",
    desc: "Xây dựng CV, nhận gợi ý cải thiện theo checkbox, xuất PDF chuyên nghiệp.",
  ...
  },
  {
    ...
    title: "AI Chat hỗ trợ 24/7",
    desc: "Tư vấn chiến lược tìm việc, chuẩn bị phỏng vấn và định hướng nghề nghiệp.",
    color: "bg-pink-50 text-pink-700",
  },
  {
    icon: <TrendingUp className="w-5 h-5" />,
    title: "Dashboard thị trường",
    desc: "Phân tích xu hướng tuyển dụng, mức lương, kỹ năng hot theo từng ngành.",
    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/auth/login"
              className="text-slate-600 hover:text-slate-900 px-4 py-2 text-sm font-medium transition-colors duration-150"
            >
              Đăng nhập
            </Link>
            <Link
              href="/auth/register"
              className="bg-accent-500 hover:bg-accent-600 text-white px-5 py-2 rounded-lg text-sm font-semibold transition-all duration-150 shadow-btn-accent hover:shadow-none"
            >
              Bắt đầu miễn phí
            </Link>
          </div>
      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-slate-900 leading-[1.05] tracking-tight mb-6">
            Tìm việc thông minh
            <br />
            <span className="text-primary-800">dành cho sinh viên</span>
            <br />
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-16">
            <Link
              href="/auth/register"
              className="inline-flex items-center justify-center gap-2 bg-accent-500 hover:bg-accent-600 text-white px-8 py-4 rounded-xl font-bold text-base transition-all duration-200 shadow-btn-accent hover:shadow-none hover:-translate-y-0.5"
            >
              Bắt đầu miễn phí
            ...
            <Link
              href="/auth/login"
              className="inline-flex items-center justify-center gap-2 border border-slate-200 hover:border-slate-300 text-slate-700 hover:text-slate-900 px-8 py-4 rounded-xl font-semibold text-base transition-all duration-200 hover:bg-slate-50"
            >
              Đã có tài khoản
            </Link>
          </div>
      ...
      <section className="py-20 px-6 bg-surface">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-500 max-w-lg mx-auto font-body">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((f, i) => (
              <div
                key={f.title}
                className="bg-white rounded-2xl p-6 border border-slate-100 shadow-card hover:shadow-card-hover hover:-translate-y-1 transition-all duration-200 cursor-default"
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-block bg-accent-100 text-accent-700 text-xs font-bold px-3 py-1.5 rounded-full uppercase tracking-widest mb-6">
                Tại sao chọn JobViet AI?
              </div>
              ...
              <p className="text-slate-500 mb-8 leading-relaxed font-body">
                JobViet AI là người đồng hành nghề nghiệp — từ lúc bạn còn chưa biết bắt đầu từ đâu,
              ...
              <Link
                href="/auth/register"
                className="inline-flex items-center gap-2 mt-10 bg-primary-800 hover:bg-primary-900 text-white px-7 py-3.5 rounded-xl font-bold text-sm transition-all duration-200 hover:-translate-y-0.5"
              >
                ...
                <div className="relative">
                  ...
                  <div className="bg-white/10 rounded-xl p-4 border border-white/10">
                    ...
                    <p className="text-white text-sm leading-relaxed font-body">
                      Bạn có nền tảng React tốt. Cần bổ sung kinh nghiệm TypeScript và
                      quen với CI/CD để cạnh tranh tốt hơn.
                    </p>
                  </div>
      ...
      <section className="py-20 px-6 bg-primary-900">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-primary-200 mb-8 font-body">
            Tạo tài khoản miễn phí và bắt đầu tìm kiếm việc làm ngay hôm nay.
          </p>
          <Link
            href="/auth/register"
            className="inline-flex items-center gap-2 bg-accent-500 hover:bg-accent-400 text-white px-10 py-4 rounded-xl font-bold text-base transition-all duration-200 shadow-btn-accent hover:-translate-y-0.5"
          >
            Đăng ký miễn phí
            <ArrowRight className="w-4 h-4" />
          </Link>
      ...
      <footer className="bg-primary-900 border-t border-white/5 py-8 px-6">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <p className="text-white/30 text-xs font-body">
            Powered by Gemini · VietnamWorks · TopCV · ITviec · CareerViet
          </p>
        </div>
      </footer>
    </div>
